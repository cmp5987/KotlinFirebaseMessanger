...
class MainActivity : AppCompatActivity() {
    ...
    private fun performRegister(){
        ...
        //To setup, get firebase dependencies
        //setup project in firebase
        //setup, firebase auth dependencies
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email, password)
            ...
            .addOnFailureListener {
                Log.d("MAINMSG", "Failed to create user: ${it.message}")
                Toast.makeText(this, "Failed to create users: ${it.message}", Toast.LENGTH_SHORT).show()
            }
